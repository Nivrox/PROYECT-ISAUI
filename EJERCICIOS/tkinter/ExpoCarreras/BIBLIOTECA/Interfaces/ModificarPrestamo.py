    ...
    def modificar_prestamo():
            ...
            if socio and dni and isbn and fecha_prestamo and fecha_devolucion:
                try:
                    ...
                    cursor.execute("SELECT nombre, apellido, dni FROM socios WHERE DNI = %s",(dni,))
                    ...
                    if id_socio:
                        ...
                        if isbn_libro:
                            ...
                            # Consulta SQL para actualizar el préstamo específico
                            sql = """
                            UPDATE prestamos
                            SET fecha_prestamo = ?, fecha_devolucion = ?, id_socios = ?
                            WHERE id_prestamos = ?;
                            """
